...
class AllRelRcds {
    ...
    public HashMap<Integer, HashMap<String, Double>> loadCosineValue(String fileName, int startQid, int endQid) throws FileNotFoundException, IOException {
